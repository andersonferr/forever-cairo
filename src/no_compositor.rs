...
unsafe extern "C" fn _cairo_no_compositor_paint(
    ...
    if (b"reached\0" as *const u8 as *const libc::c_char).is_null() {} else {
        __assert_fail(
            ...
            b"../src/cairo-no-compositor.c\0" as *const u8 as *const libc::c_char,
            50 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<
                &[u8; 106],
                &[libc::c_char; 106],
            >(
                b"cairo_int_status_t _cairo_no_compositor_paint(const cairo_compositor_t *, cairo_composite_rectangles_t *)\0",
            ))
                .as_ptr(),
        );
    }
...
unsafe extern "C" fn _cairo_no_compositor_mask(
    ...
    if (b"reached\0" as *const u8 as *const libc::c_char).is_null() {} else {
        __assert_fail(
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 105],
            >(
                b"cairo_int_status_t _cairo_no_compositor_mask(const cairo_compositor_t *, cairo_composite_rectangles_t *)\0",
            ))
                .as_ptr(),
        );
    }
...
unsafe extern "C" fn _cairo_no_compositor_stroke(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
    ...
    if (b"reached\0" as *const u8 as *const libc::c_char).is_null() {} else {
        __assert_fail(
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 240],
            >(
                b"cairo_int_status_t _cairo_no_compositor_stroke(const cairo_compositor_t *, cairo_composite_rectangles_t *, const cairo_path_fixed_t *, const cairo_stroke_style_t *, const cairo_matrix_t *, const cairo_matrix_t *, double, cairo_antialias_t)\0",
            ))
                .as_ptr(),
        );
    }
...
unsafe extern "C" fn _cairo_no_compositor_fill(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
    mut path: *const cairo_path_fixed_t,
    ...
    if (b"reached\0" as *const u8 as *const libc::c_char).is_null() {} else {
        __assert_fail(
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 179],
            >(
                b"cairo_int_status_t _cairo_no_compositor_fill(const cairo_compositor_t *, cairo_composite_rectangles_t *, const cairo_path_fixed_t *, cairo_fill_rule_t, double, cairo_antialias_t)\0",
            ))
                .as_ptr(),
        );
    }
...
unsafe extern "C" fn _cairo_no_compositor_glyphs(
    mut compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
    ...
    if (b"reached\0" as *const u8 as *const libc::c_char).is_null() {} else {
        __assert_fail(
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 166],
            >(
                b"cairo_int_status_t _cairo_no_compositor_glyphs(const cairo_compositor_t *, cairo_composite_rectangles_t *, cairo_scaled_font_t *, cairo_glyph_t *, int, cairo_bool_t)\0",
            ))
                .as_ptr(),
        );
    }
...
#[no_mangle]
pub static mut __cairo_no_compositor: cairo_compositor_t = unsafe {
    {
