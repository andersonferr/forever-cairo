...
unsafe extern "C" fn _cairo_fallback_compositor_paint(
    ...
    image = _cairo_surface_map_to_image((*extents).surface, &mut (*extents).unbounded);
...
unsafe extern "C" fn _cairo_fallback_compositor_mask(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
) -> cairo_int_status_t {
    let mut image: *mut cairo_image_surface_t = 0 as *mut cairo_image_surface_t;
...
unsafe extern "C" fn _cairo_fallback_compositor_stroke(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
...
unsafe extern "C" fn _cairo_fallback_compositor_fill(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
    mut path: *const cairo_path_fixed_t,
...
unsafe extern "C" fn _cairo_fallback_compositor_glyphs(
    mut _compositor: *const cairo_compositor_t,
    mut extents: *mut cairo_composite_rectangles_t,
...
#[no_mangle]
pub static mut _cairo_fallback_compositor: cairo_compositor_t = unsafe {
    {
