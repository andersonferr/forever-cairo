...
#[no_mangle]
pub unsafe extern "C" fn _cairo_surface_fallback_paint(
    ...
    return _cairo_compositor_paint(
        ...
        surface as *mut cairo_surface_t,
        op,
        source,
        clip,
    );
...
#[no_mangle]
pub unsafe extern "C" fn _cairo_surface_fallback_mask(
    mut surface: *mut libc::c_void,
    mut op: cairo_operator_t,
    mut source: *const cairo_pattern_t,
...
#[no_mangle]
pub unsafe extern "C" fn _cairo_surface_fallback_stroke(
    mut surface: *mut libc::c_void,
    mut op: cairo_operator_t,
    mut source: *const cairo_pattern_t,
...
#[no_mangle]
pub unsafe extern "C" fn _cairo_surface_fallback_fill(
    mut surface: *mut libc::c_void,
    mut op: cairo_operator_t,
    mut source: *const cairo_pattern_t,
    mut path: *const cairo_path_fixed_t,
...
#[no_mangle]
pub unsafe extern "C" fn _cairo_surface_fallback_glyphs(
    mut surface: *mut libc::c_void,
    mut op: cairo_operator_t,
    mut source: *const cairo_pattern_t,
